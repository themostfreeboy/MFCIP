...
LPCWSTR MyCharToLPCWSTR(const char* szStrtemp);//char*转LPCWSTR
LPWSTR MyCharToLPWSTR(const char* szStrtemp);//char*转LPWSTR
CString MyCharToCString(const char* szStrtemp);//char*转CString
